...
module.exports =
  stats: (req, res) ->
    ...
    shelljs.exec "hadoop fs -mkdir /lab2"
    shelljs.exec "hadoop fs -mkdir /lab2/stats"
    shelljs.exec "hadoop fs -mkdir /lab2/stats/url"
    shelljs.exec "hadoop fs -mkdir /lab2/stats/browser"
    shelljs.exec "hadoop fs -copyFromLocal ./request.log /lab2/request.log"
    shelljs.exec "sleep 5"
